            ...
            child: RefreshIndicator(
              ...
              child: FutureBuilder(
                  ...
                  builder: (context, snapShot) {
                    ...
                    int rateAcc =
                        snapShot.data!['reviews'].fold(0, (prev, item) {
                      return prev + item['rating'];
                    });
                    double avgRating =
                        rateAcc / snapShot.data!['reviews'].length;
                    ...
                    return Column(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style:
                              MyTextTheme.productPrice.copyWith(fontSize: 16),
                        ),
                        const SizedBox(
                          height: 13,
                        ),
                            ...
                            children: [
                              ClipRRect(
                                ...
                                child: SizedBox(
                                    ...
                                    height: 45,
                                    child:
                                        Image.network(storeInfo['imagePath'])),
                              ),
                              const SizedBox(
                                width: 20,
                              ),
